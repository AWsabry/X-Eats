class AppConstants {
  static String delivering = "Delivering to";
  static String deliveringNileUniversity = "Nile University, Giza";
  static String searchingForRestaurants = "Search For Restaurants";
